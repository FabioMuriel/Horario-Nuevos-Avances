$(document).ready(function () {
    ...
    function llenarCompetenciaFicha(ficha_horario) {
        $.ajax({
            ...
            $("#competencia_horarioE").html(CompetenciaSelect).selectpicker('refresh');
    ...
    function llenarResultados(id_competencia) {
        $.ajax({
            ...
            $("#resultado_horarioE").html(ResultadoSelect).selectpicker('refresh');
    ...
    function llenarProgramaAgregar(id_sede) {
        $.ajax({
            ...
            $("#programa_horarioE").html(programaSelect).selectpicker('refresh');
    ...
    function llenarFichaPorSede(id) {
        $.ajax({
            url: "app/controlador/ConfiguracionControlador.php",
            type: 'post',
            datatype: "json",
            ...
            $("#ficha_horarioE").html(fvsiSelect).selectpicker('refresh');
    ...
    function llenarInstructorPorSede(id_sede) {
        $.ajax({
            ...
            $("#instructor_horarioE").html(instructorSelect).selectpicker('refresh');
    ...
    $("#ficha_horario").change(function () {
        ...
        llenarCompetenciaFicha(ficha_horario);
    });

    $("#programa_horario").change(function () {
        id = $("#programa_horario").val();
        llenarFichaPorSede(id)
    });

    //Changes del modal editar

    $("#programa_horarioE").change(function () {
        id = $("#programa_horarioE").val();
        llenarFichaPorSede(id)
    });

    $("#ficha_horarioE").change(function () {
        ficha_horario = $("#id_compe").val();
        llenarCompetenciaFicha(ficha_horario);
    })
    $("#competencia_horarioE").change(function () {
